...
public class InputEventHandler : MonoBehaviour {
    ...
    [Tooltip("These functions will be called, when any button is pressed or touch input is made")]
    public UnityEvent onPressAny;
    [Tooltip("These functions will be called, when the the left mouse button is pressed")]
    public UnityEvent onPressMouse0;
    ...
    void Start ()
    {
        ...
        StartEvent(onPressAny);
        StartEvent(onPressMouse0);
    }
